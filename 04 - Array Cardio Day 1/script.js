...
const filteredInventorsByYearsOfBirth = inventors.filter(
  (inventor) => inventor.year >= 1500 && inventor.year < 1600
);

console.table(filteredInventorsByYearsOfBirth);
...
const allYearsOfLife = inventors.reduce((total, inventor) => {
  return total + (inventor.passed - inventor.year);
}, 0);

console.log("total years lived: ", allYearsOfLife);
...
const oldest = inventors.sort((a, b) => {
  ...
  return nextInvestor - lastInvestor;
});
